public class Main {
    ...
    public static void main(String[] args) {
        System.out.println(zad3_2(4, 2, 4));
        System.out.println(zad3_2(125, 3, 4));
        System.out.println(zad2_2(48));
        System.out.println(zad2_2(15));
        ...
        System.out.println(zad4(new int[]{1, 2, 0, 3, 5, 7, 4}));
        System.out.println(zad4(new int[]{1, 2, 3, 4, 5, 6, 7}));
        System.out.println(zad5(new int[]{1, 2, 0, 3, 5, 1, 4}, 3));
        System.out.println(zad5(new int[]{1, 2, 0, 3, 5, 7, 4}, 2));
        System.out.println(zad5(new int[]{1, 2, 3, 4, 5, 6, 7}, 4));
        System.out.println();
        zad6(10, 6);
        System.out.println();
        zad7(10, 6);
